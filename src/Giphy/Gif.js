    ...
    renderStill(){
        return(
            <div style={{minWidth: "350px", minHeight: "350px"}}>
                ...
                <img style={{maxWidth: "300px", maxHeight: "300px"}} src={this.props.still} onClick={this.handleClick}/>
            </div>
        )
    }
    renderMoving(){
        return(
            <div style={{minWidth: "350px", minHeight: "350px"}}>
                ...
                <img style={{maxWidth: "300px", maxHeight: "300px"}} src={this.props.moving} onClick={this.handleClick}/>
            </div>
        )
    }
